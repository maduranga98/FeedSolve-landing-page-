...
const postVisuals: Record<number, {
 ...
 1: {
  ...
  avatarBg: "var(--navy)",
  avatarInitials: "M",
  author: "Maduranga, founder of FeedSolve",
  date: "Apr 25, 2026",
  readTime: "5 min",
 },
 2: {
     ...
     <div className="listing-featured">
      <div>
       ...
       <div className="listing-post-meta">
        <div className="listing-author-avatar" style={{ background: "var(--teal)" }}>M</div>
        <div className="listing-post-meta-text">
         <div className="meta-name">Maduranga, founder of FeedSolve</div>
