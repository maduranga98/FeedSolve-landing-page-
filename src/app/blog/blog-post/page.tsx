  ...
  <>
      ...
      {[
       {
        ...
        title: "Complaint Resolution Workflow for SMBs: A 5-Stage Kanban That Actually Closes Issues",
        meta: "5 min read",
       },
       {
        href: "/blog/qr-code-feedback-board/",
        iconBg: "#EEF2FF",
        ...
        title: "QR Code Feedback Board: The Fastest Way to Collect Complaints Without a Form",
        meta: "4 min read",
       },
       {
        href: "/blog/close-the-feedback-loop/",
        iconBg: "#E8F5E9",
        ...
        title: "How to Close the Feedback Loop: From Collection to Resolution in 4 Steps",
        meta: "4 min read",
       },
   ...
   <div className="more-posts-section">
    ...
    <div className="more-grid">
     {[
      { tag: "Operations", tagColor: "var(--teal)", href: "/blog/complaint-resolution-workflow-smb/", title: "Complaint Resolution Workflow for SMBs: A 5-Stage Kanban That Actually Closes Issues", desc: "A step-by-step model that moves complaints from received to resolved with full accountability.", meta: "FeedSolve Team · Apr 1, 2026" },
      { tag: "QR Codes", tagColor: "#3730A3", href: "/blog/qr-code-feedback-board/", title: "QR Code Feedback Board: The Fastest Way to Collect Complaints Without a Form", desc: "Collect feedback via QR code without requiring login. Here's how to set one up in minutes.", meta: "FeedSolve Team · Apr 22, 2026" },
      { tag: "Guides", tagColor: "#E65100", href: "/blog/close-the-feedback-loop/", title: "How to Close the Feedback Loop: From Collection to Resolution in 4 Steps", desc: "The 4-step process for turning raw feedback into a resolved, documented outcome.", meta: "FeedSolve Team · Mar 2026" },
     ].map(({ tag, tagColor, href, title, desc, meta }, i) => (
      <Link key={i} href={href} className="more-card">
