// src/app/eu/gdpr-feedback-management/page.tsx
...
// Note: In Next.js, export metadata must be in a server component.
// Split this into page.tsx (server) + GDPRPageClient.tsx (client).
// The metadata export below is for the server component.
