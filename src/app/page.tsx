      ...
      <div className="hero-inner">
        <div className="hero-left">
          ...
          <h1 className="hero-title">
            Stop losing
            <br />
            <span className="accent">complaints.</span>
            <br />
            Start closing them.
          </h1>
        ...
        <div className="sol-proof">
          <div className="sol-proof-item">
            ...
            <div>
              ...
              <div className="sol-proof-l">Average setup time</div>
            </div>
          </div>
          <div className="sol-proof-item">
            <div className="sol-proof-icon">
            ...
            <div>
              <div className="sol-proof-n">4x</div>
              <div className="sol-proof-l">Faster resolution vs chat</div>
            </div>
          </div>
          <div className="sol-proof-item">
            <div className="sol-proof-icon">
            ...
            <div>
              ...
              <div className="sol-proof-l">Issues tracked, none lost</div>
            </div>
          </div>
          <div className="sol-proof-item">
            <div className="sol-proof-icon">
            ...
            <div>
              <div className="sol-proof-n">91%</div>
              <div className="sol-proof-l">Customer satisfaction lift</div>
            </div>
          </div>
        </div>
      </div>
